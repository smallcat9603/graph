...
if DATA_TYPE == "TXT":
    ...
    DATA_URL = f"{param.DATA_DIR}articles.csv"
...
with tab2:
    query_interact_multiple_queries = cypher.interact_multiple_queries(QUERY_DICT)
with tab3:
...
with st.expander("Debug Info"):
    ...
    st.header("query_interact_multiple_queries")
