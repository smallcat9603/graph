...
tests/CMakeFiles/test_igraph_weighted_cliques.dir/unit/igraph_weighted_cliques.c.o: /github/graph/igraph-0.10.4/tests/unit/igraph_weighted_cliques.c
...
tests/CMakeFiles/test_igraph_weighted_cliques.dir/unit/igraph_weighted_cliques.c.i: cmake_force
	...
	cd /github/graph/igraph-0.10.4/build/tests && /usr/bin/cc $(C_DEFINES) $(C_INCLUDES) $(C_FLAGS) -E /github/graph/igraph-0.10.4/tests/unit/igraph_weighted_cliques.c > CMakeFiles/test_igraph_weighted_cliques.dir/unit/igraph_weighted_cliques.c.i
...
tests/CMakeFiles/test_igraph_weighted_cliques.dir/unit/igraph_weighted_cliques.c.s: cmake_force
	...
	cd /github/graph/igraph-0.10.4/build/tests && /usr/bin/cc $(C_DEFINES) $(C_INCLUDES) $(C_FLAGS) -S /github/graph/igraph-0.10.4/tests/unit/igraph_weighted_cliques.c -o CMakeFiles/test_igraph_weighted_cliques.dir/unit/igraph_weighted_cliques.c.s
...
tests/test_igraph_weighted_cliques: src/libigraph.a
tests/test_igraph_weighted_cliques: /usr/lib/aarch64-linux-gnu/libm.so
tests/test_igraph_weighted_cliques: /usr/lib/aarch64-linux-gnu/libblas.so
tests/test_igraph_weighted_cliques: /usr/lib/aarch64-linux-gnu/libf77blas.so
tests/test_igraph_weighted_cliques: /usr/lib/aarch64-linux-gnu/libatlas.so
tests/test_igraph_weighted_cliques: /usr/lib/aarch64-linux-gnu/liblapack.so
tests/test_igraph_weighted_cliques: /usr/lib/aarch64-linux-gnu/libblas.so
tests/test_igraph_weighted_cliques: /usr/lib/aarch64-linux-gnu/libf77blas.so
tests/test_igraph_weighted_cliques: /usr/lib/aarch64-linux-gnu/libatlas.so
tests/test_igraph_weighted_cliques: /usr/lib/aarch64-linux-gnu/liblapack.so
tests/test_igraph_weighted_cliques: /usr/lib/aarch64-linux-gnu/libxml2.so
tests/test_igraph_weighted_cliques: /usr/lib/gcc/aarch64-linux-gnu/9/libgomp.so
tests/test_igraph_weighted_cliques: /usr/lib/aarch64-linux-gnu/libpthread.so
tests/test_igraph_weighted_cliques: tests/CMakeFiles/test_igraph_weighted_cliques.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/github/graph/igraph-0.10.4/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking CXX executable test_igraph_weighted_cliques"
	cd /github/graph/igraph-0.10.4/build/tests && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/test_igraph_weighted_cliques.dir/link.txt --verbose=$(VERBOSE)
...
tests/CMakeFiles/test_igraph_weighted_cliques.dir/clean:
	cd /github/graph/igraph-0.10.4/build/tests && $(CMAKE_COMMAND) -P CMakeFiles/test_igraph_weighted_cliques.dir/cmake_clean.cmake
