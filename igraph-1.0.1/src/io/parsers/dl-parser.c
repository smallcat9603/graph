...
;}
  ...
  case 40:
    ...
    {
                    igraph_int_t from = (yyvsp[(1) - (4)].integer), to = (yyvsp[(2) - (4)].integer);
                    IGRAPH_YY_CHECK(igraph_i_dl_check_vid(from));
                    IGRAPH_YY_CHECK(igraph_i_dl_check_vid(to));
                    IGRAPH_YY_CHECK(igraph_i_dl_add_edge_w(from-1, to-1, (yyvsp[(3) - (4)].real), context)); ;}
    break;

  case 41:

    {
                    igraph_int_t from = (yyvsp[(1) - (3)].integer), to = (yyvsp[(2) - (3)].integer);
                    IGRAPH_YY_CHECK(igraph_i_dl_check_vid(from));
                    IGRAPH_YY_CHECK(igraph_i_dl_check_vid(to));
...
;}
  ...
  case 45:
    ...
    {
                          IGRAPH_YY_CHECK(igraph_i_dl_add_edge_w((yyvsp[(1) - (4)].integer), (yyvsp[(2) - (4)].integer), (yyvsp[(3) - (4)].real), context)); ;}
    break;

  case 46:

    {
                          IGRAPH_YY_CHECK(igraph_i_dl_add_edge((yyvsp[(1) - (3)].integer), (yyvsp[(2) - (3)].integer), context));
 ;}
    break;
...
;}
  ...
  case 60:
    ...
    {
  igraph_int_t to = (yyvsp[(2) - (2)].integer);
  IGRAPH_YY_CHECK(igraph_i_dl_check_vid(to));
  IGRAPH_YY_CHECK(igraph_vector_int_push_back(&context->edges,
                                              context->from-1));
 ...
 ;}
  ...
  IGRAPH_YY_CHECK(igraph_vector_int_push_back(&context->edges,
                                              context->from));
  IGRAPH_YY_CHECK(igraph_vector_int_push_back(&context->edges, (yyvsp[(2) - (2)].integer)));
 ;}
    break;
