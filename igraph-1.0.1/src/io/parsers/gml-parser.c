...
yyreduce:
  ...
  case 5:
    ...
    { IGRAPH_YY_CHECK(igraph_i_gml_merge((yyvsp[(1) - (2)].tree), (yyvsp[(2) - (2)].tree))); (yyval.tree) = (yyvsp[(1) - (2)].tree); ;}
    break;

  case 6:

    { IGRAPH_YY_CHECK(igraph_i_gml_make_numeric((yyvsp[(1) - (2)].str), (yylsp[(1) - (2)]).first_line, (yyvsp[(2) - (2)].real), &(yyval.tree))); ;}
    break;

  case 7:

    { IGRAPH_YY_CHECK(igraph_i_gml_make_string((yyvsp[(1) - (2)].str), (yylsp[(1) - (2)]).first_line, (yyvsp[(2) - (2)].str), &(yyval.tree))); ;}
    break;

  case 8:

    { IGRAPH_YY_CHECK(igraph_i_gml_make_list((yyvsp[(1) - (4)].str), (yylsp[(1) - (4)]).first_line, (yyvsp[(3) - (4)].tree), &(yyval.tree))); ;}
    break;
