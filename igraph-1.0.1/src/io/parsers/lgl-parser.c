...
static const char *const yytname[] =
{
  ...
  "vertexdef", "edges", "edge", "edgeid", "weight", 0
};
#endif
...
yyreduce:
  ...
  case 9:

    {
             ...
             IGRAPH_YY_CHECK(igraph_vector_int_push_back(context->vector, (yyvsp[(1) - (2)].edgenum)));
  ...
  case 10:
    ...
    {
             IGRAPH_YY_CHECK(igraph_vector_int_push_back(context->vector, context->actvertex));
             IGRAPH_YY_CHECK(igraph_vector_int_push_back(context->vector, (yyvsp[(1) - (3)].edgenum)));
             IGRAPH_YY_CHECK(igraph_vector_push_back(context->weights, (yyvsp[(2) - (3)].weightnum)));
